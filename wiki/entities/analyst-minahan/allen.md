...
Minahan/Allen is a person in IT Research / Industry Analysis. Active 2002. Status: unknown.
...
```sql
SELECT * FROM observations WHERE entity_id = 'analyst-minahan/allen';
```
