...
Insession Inc. is a company in enterprise-software. Active 1990-2000s. Status: unknown.
...
```sql
SELECT * FROM observations WHERE entity_id = 'insession';
```
