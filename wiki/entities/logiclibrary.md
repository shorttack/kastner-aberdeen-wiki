...
obs_count: 1
aliases: []
tags: [type/entity, sector/software, status/deferred]
source_csv: known_entities.csv
---

# LogicLibrary

LogicLibrary is a company in software. Active 1999-2001. Status: [DEFERRED].
...
```sql
SELECT * FROM observations WHERE entity_id = 'logiclibrary';
```
