...
> ChatGPT (2022) and GPT-4 (2023) — the LLM-era convergence endpoint for all threads in the arc; provides the 2022 baseline year for predictive distance calculations
