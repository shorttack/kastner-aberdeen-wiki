...
- Acquired by Sun Microsystems July 1998 for approximately $160-170M in stock; NetDynamics became Sun Application Server `[ps=5]` — [[study-aberdeen-1996-spider-technologies-netdynamics]]
- Cross-category positioning: more web-focused than C/S toolset providers; more toolset-complete than middleware providers; multi-RDBMS vs. RDBMS suppliers `[ps=4]` — [[study-aberdeen-1996-spider-technologies-netdynamics]]
