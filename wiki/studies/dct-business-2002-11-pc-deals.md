...
slug: dct-business-2002-11-pc-deals
page_type: study
...
**Author:** Peter S. Kastner · **Date:** 2002-11-08 · **Type:** dct
...
```sql
SELECT * FROM observations WHERE study_id = 'dct-business-2002-11-pc-deals' ORDER BY year_observed;
```
