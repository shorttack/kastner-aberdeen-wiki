...
slug: dct-business-2002-12-19-pc-deals
page_type: study
...
**Author:** Peter S. Kastner · **Date:** 2002-12-19 · **Type:** dct
...
- [[15-inch-lcd|15-inch LCD Monitor]]
...
- [[intel-pentium-4-m|Intel Pentium 4-M (Mobile)]]
- [[lcd-flat-panel|LCD Flat Panel Monitor]]
- [[notebook-pc|Notebook PC]]
- [[small-form-factor-pc|Small Form Factor PC (SFF)]]
...
```sql
SELECT * FROM observations WHERE study_id = 'dct-business-2002-12-19-pc-deals' ORDER BY year_observed;
```
