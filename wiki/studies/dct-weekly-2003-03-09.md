...
**Author:** Peter S. Kastner · **Date:** 2003-03-09 · **Type:** dct
...
```sql
SELECT * FROM observations WHERE study_id = 'dct-weekly-2003-03-09' ORDER BY year_observed;
```
