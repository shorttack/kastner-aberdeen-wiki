...
slug: "study-04-mid-line-storage-v2-whitepaper-7db9bc"
page_type: "study"
...
_Published 2003, author **Aberdeen Group**, type **white-paper**._


## Top observations

- ATA disk up to 300 GB per disk vs 142/72/36 GB per FC/SCSI disk — 2x to 8x capacity advantage `[ps=5]`
...
- Mid-line storage is a 'quiet' revolution — enterprises still learning best use of the new tier but widespread adoption predicted `[ps=5]`
- About half said operational management required for backup is a burden and management concern `[ps=4]`
- Close to half would not guarantee all critical data can be restored on a given day `[ps=4]`
- 75% of storage buyers moderately or highly likely to buy mid-line storage in the coming year (40% highly likely; 33% moderately likely) `[ps=4]`
- Mid-line storage emerging in spite of storage buyer inertia with support of major disk drive manufacturers storage systems suppliers and early adopters `[ps=4]`
