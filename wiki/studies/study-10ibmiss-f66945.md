...
- **3-year verdict:** medium — 3y Rule A: mean=3.00 over 7 usable obs (23 prefiltered, 0 pending) -> medium [high>=3.5, medium>=2.0].
- **5-year verdict:** high — 5y Rule A: mean=3.57 over 7 usable obs (23 prefiltered, 0 pending) -> high [high>=3.5, medium>=2.0].
...
_Published 1991, author **Peter S. Kastner**, type **white-paper**._
