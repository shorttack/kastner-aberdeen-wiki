...
slug: "study-12-steps-to-category-creation-0abd5a"
page_type: "study"
...
- [long-term marketing outreach program for growing and sustaining the category] `[ps=4]`
- We will fail if we try to own the IP; successful categories require open thought leadership that others can adopt `[ps=4]`
- Size; Growth; Revenues; Taking share from existing categories; Winners and losers `[ps=3]`
