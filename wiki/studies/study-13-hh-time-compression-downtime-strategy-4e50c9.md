...
- Savings 1 (initial cost savings) + Savings 2 (backup time compression savings); includes opportunity cost savings at 0.6 multiplier
- CostO = cost(E GB online disk) + cost(G GB nearline tape) + cost(H GB offline tape)
- CostN = cost(E/2 online disk) + cost(E/2 midline disk) + cost(G/2 nearline disk) + cost(G/2 nearline tape) + cost(H offline tape); assumes online disk split in half and nearline tape split in half
...
- X = 800 GB/hr
- Y = 1600 GB/hr
- Medium/large financial services company; 1 million customers; 100K overseas business customers; 120 customers served/hour; $100/customer
- E = 3 TB critical data requiring backup
...
- 20TB nearline disk: $100K at $5/GB; 4-drive 100-slot tape library: $85K + $10K media = $95K; 40TB tape capacity at $2.50/GB; total combo: $195K
- $31.60/GB (HDS 9980V with 146GB disks)
- $13.30/GB (EMC CX600 with 146GB disks)
- $9.30/GB (70% of EMC midrange price)
- $10/hour ($100K salary * 1/10000 hours per year)
- Savings 2 = (customers served/hour * $/customer * backup time saved) + ($10 * backup time saved in hours)
