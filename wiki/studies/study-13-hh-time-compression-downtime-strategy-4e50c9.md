...
- Old Way: A = M/X hours; New Way: B = M/(2X) hours (parallel backup); backup time saved = A - B = M/(2X) `[ps=4]`
- Midline disk at 70% of midrange ($9.30/GB vs $13.30/GB) will enable measurable TCO savings in New Way architecture `[ps=4]`
- CostO = cost(E GB online disk) + cost(G GB nearline tape) + cost(H GB offline tape) `[ps=3]`
- Opportunity cost savings = 0.6 * direct cost savings from New solution `[ps=2]`
...
- $130K for 8-drive 200-slot system; LTO-2 (400MB/cartridge at 40MB/sec 2:1 compression); $20K media (100/cartridge); total $150K; 80TB capacity; $1.90/GB `[ps=0]`
