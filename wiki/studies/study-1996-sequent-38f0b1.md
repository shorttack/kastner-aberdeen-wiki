...
slug: "study-1996-sequent-38f0b1"
page_type: "study"
...
_Published 1996, author **Peter S. Kastner**, type **presentation**._
...
- Message-passing burns CPU and memory cycles; messaging between nodes is very complex technology requiring time to mature `[ps=4]`
- Aimed at world's toughest commercial computing problems: OLTP, complex DSS, and messaging `[ps=4]`
- 3x-5x increases in demand for information resources over next 5 years (by 2001) `[ps=4]`
- 10x-15x more client and server CPU horsepower by 2001 `[ps=4]`
- Like 1996, the information highway will still be under construction in 2001 `[ps=4]`
- There is no time for application downtime -- the computer system is the business `[ps=4]`
- Good scaling to 4 processors; fair to 8; diminishing returns beyond 10 `[ps=4]`
