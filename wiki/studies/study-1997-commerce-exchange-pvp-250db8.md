---
title: "Commerce eXchange Answers The 'Show Me The Internet Money!' Challenge"
slug: "study-1997-commerce-exchange-pvp-250db8"
page_type: "study"
tags: ["type/study", "collection/product-viewpoint"]
tier: 1
source_csv: "_master_studies.csv"
study_id: "1997-commerce-exchange-pvp-250db8"
author: "Aberdeen Group"
date: "1997-03-14"
pub_year: 1997
type: "product-viewpoint"
subject_domain: "internet-commerce"
methodology: "field-research, product-profiling, user-research, industry-analysis"
source_file: "1997 Commerce eXchange pvp.pdf"
license: "CC-BY-4.0"
importance: "high"
relevance: "high"
...
- Lack of solution breadth; large-scale interactive sites must be open, scalable, and integrate multiple point products and legacy systems `[ps=4]`
- Web-enabled extensions of client-server or legacy applications will not adequately serve as Fortune 1000 Internet retail solutions; won't scale to millions of users; not designed for consumer interaction `[ps=4]`
- 1997 will see explosive internet sales for financial services, discount brokerages, industrial and consumer catalogs, travel services, food services, retail products from books to automobiles `[ps=4]`
...
- Aberdeen strongly endorses Commerce eXchange; recommends it for corporations and entrepreneurs opening internet sales channels; positions it as having production-quality credentials with multiple successful deployments `[ps=2]`
- $520 million emerging Internet goods market; computer hardware and software comprised ~37% `[ps=0]`
- Greater than $1 million when requiring complex integration `[ps=0]`
