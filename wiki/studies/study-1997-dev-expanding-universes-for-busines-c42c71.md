...
- Large user with 5,000-copy rollout plans concluded that combination of strong technology and maturity would translate into a sustainable platform for competitive advantage `[ps=3]`
- BusinessObjects schemaless approach to multidimensionality works with any relational schema; no need for star or snowflake schemas or proprietary MOLAP tools `[ps=2]`
...
- Telemarketing is responsible for sales between approximately $20,000 and $50,000 `[ps=0]`
