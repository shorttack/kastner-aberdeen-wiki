...
slug: "study-1997-ibm-extended-transaction-systems-fa-0369fa"
page_type: "study"
tags: ["type/study", "collection/Profile"]
tier: 1
source_csv: "_master_studies.csv"
study_id: "1997-ibm-extended-transaction-systems-fa-0369fa"
...
source_file: "1997 IBM Extended Transaction Systems Family pr.pdf"
license: "CC-BY-4.0"
importance: "high"
relevance: "high"
...
- **3-year verdict:** high — 3y Rule A: mean=4.08 over 24 usable obs (0 prefiltered, 1 pending) -> high; 1 obs still pending (verdict may shift) [high>=3.5, medium>=2.0].
- **5-year verdict:** high — 5y Rule A: mean=4.25 over 24 usable obs (0 prefiltered, 1 pending) -> high; 1 obs still pending (verdict may shift) [high>=3.5, medium>=2.0].
...
- ETS deserves IS buyers' closest attention; highly attractive network-computing family `[ps=3]`
