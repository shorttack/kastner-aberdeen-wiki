...
- Access Point's IQ software permits IT managers to establish traffic priorities and allocate bandwidth percentages; class defined by IP address range TCP/UDP ports `[ps=0]`
