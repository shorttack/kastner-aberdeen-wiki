...
- NT 5.0 will not ship until late 1999 at earliest; may be delayed by 6-12 months `[ps=5]`
- Windows 2000 RTM December 15 1999; GA February 17 2000 — consistent with Aberdeen's late-1999 prediction `[ps=5]`
- Smaller orgs unaffected; mid- and large-sized organizations will need major effort to deploy NT beyond workgroup and across the enterprise via Active Directory `[ps=5]`
- IA-64 Itanium never achieved mass market; Intel discontinued Itanium in July 2021; Aberdeen's conditional 64-bit prediction never triggered `[ps=5]`
- NT market penetration at 25%; new-market share at 40% and growing by some estimates `[ps=4]`
- Many immediately-needed robustness improvements folded into Service Pack 4 for NT 4.0 due October 1998; NT 5.0 will offer less added bang for some customers' bucks `[ps=4]`
- Short-term developer productivity will go down sharply; long-term benefits from integrated directory services and enhanced file services `[ps=4]`
- ZAW reaches full stride with NT 5.0 FCS; but will not deliver zero administration without ISV tools that won't arrive until 1-2 years post-FCS `[ps=4]`
