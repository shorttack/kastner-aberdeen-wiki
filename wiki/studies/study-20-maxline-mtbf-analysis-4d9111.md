...
- 22.815 years (Failure Ratio vs FC: 0.3504) `[ps=2]`
- MaXLine 13.69 years vs FC 3.997 years (Failure Ratio: 0.292) `[ps=2]`
- MaXLine 13.69 years vs FC 7.995 years (Failure Ratio: 0.584) `[ps=2]`
- 1200000 hours (136.89 years) `[ps=1]`
- MaXLine 5.476 years vs FC 0.799 years (Failure Ratio: 0.146) `[ps=1]`
- 8766 hours per year `[ps=0]`
- 1000000 hours (114.08 years) `[ps=0]`
- 250GB raw; 200GB at 80% loading; 5 drives per TB at 80% loading `[ps=0]`
- 73GB raw; 58.4GB at 80% loading; 17.12 drives per TB at 80% loading `[ps=0]`
