---
title: "The Enterprise AI Arc: From XCON (1980) to Oracle 23ai (2024) — Forty-Four Years of AI-Adjacent Product Claims in the Kastner Archive"
slug: "study-2026-kastner-enterprise-ai-arc"
page_type: "study"
tags: ["type/study", "collection/topic-analysis"]
tier: 2
source_csv: "_master_studies.csv"
study_id: "2026-kastner-enterprise-ai-arc"
...
methodology: "archive-mining,longitudinal-cross-entity,prediction-vs-outcome-scorecard,thematic-thread-decomposition,wiki-driven-replication,specificity-scoring"
source_file: "enterprise_ai_arc_source.md"
license: "CC-BY-4.0"
importance: "high"
relevance: "high"
...
- **3-year verdict:** medium — 3y Rule A: mean=2.59 over 66 usable obs (0 prefiltered, 12 pending) -> medium; 12 obs still pending (verdict may shift) [high>=3.5, medium>=2.0].
- **5-year verdict:** medium — 5y Rule A: mean=2.75 over 60 usable obs (0 prefiltered, 18 pending) -> medium; 18 obs still pending (verdict may shift) [high>=3.5, medium>=2.0].
...
_Published 2026, author **Peter S. Kastner (assembled with Perplexity Computer using archival-ingest v16)**, type **topic-analysis**._
