...
slug: "study-aberdeen-1995-novell-predicament"
page_type: "study"
tags: ["type/study", "collection/market-viewpoint"]
tier: 1
source_csv: "_master_studies.csv"
study_id: "aberdeen-1995-novell-predicament"
...
source_file: "1995 The Novell Predicament mvp.pdf"
license: "CC-BY-4.0"
importance: "high"
relevance: "high"
...
- **3-year verdict:** high — 3y Rule A: mean=4.00 over 27 usable obs (0 prefiltered, 1 pending) -> high; 1 obs still pending (verdict may shift) [high>=3.5, medium>=2.0].
- **5-year verdict:** high — 5y Rule A: mean=4.15 over 27 usable obs (0 prefiltered, 1 pending) -> high; 1 obs still pending (verdict may shift) [high>=3.5, medium>=2.0].
...
_Published 1995, author **Aberdeen Group**, type **market-viewpoint**._
...
- IT executives advised to carefully evaluate NetWare use for medium and long term `[ps=4]`
- ManageWise vs CA Unicenter vs HP OpenView as competing network management frameworks `[ps=3]`
- NDS targeted at multimedia/telecom, home, retail POS, healthcare—beyond corporate LAN `[ps=3]`
