---
title: "Blyth's REN Architecture: A Prescription for IT Success"
slug: "study-aberdeen-1996-blyths-ren-architecture-prescription-it-success"
page_type: "study"
tags: ["type/study", "collection/market-study"]
tier: 1
source_csv: "_master_studies.csv"
study_id: "aberdeen-1996-blyths-ren-architecture-prescription-it-success"
author: "Aberdeen Group"
date: "1996-01-01"
pub_year: 1996
type: "market-study"
subject_domain: "application-development-tools"
methodology: "industry-analysis, competitive-profiling, field-research, expert-opinion"
source_file: "1996 Blyth's REN Architecture_ A Prescription for IT Success pr.pdf"
license: "CC-BY-4.0"
importance: "medium"
relevance: "medium"
...
- Repository-based application life-cycle management tools `[ps=5]`
- Manages HTML, graphics, CGI scripts, Java applets in single version-controlled site; time-sensitive content publishing `[ps=5]`
- Mission-critical Net applications should grow dramatically in 1997 and beyond as Net-enabled electronic commerce takes off `[ps=5]`
- Reusable software components (Weblets) `[ps=4]`
- TCP sockets, FTP, SMTP/POP3/MIME email, HTTP client/server, HTML generation, Java code generation `[ps=4]`
