---
title: "Clarify Inc."
slug: "study-aberdeen-1996-clarify-inc"
page_type: "study"
tags: ["type/study", "collection/market-study"]
tier: 1
source_csv: "_master_studies.csv"
study_id: "aberdeen-1996-clarify-inc"
...
source_file: "1996 Clarify Inc dev pr..pdf"
license: "CC-BY-4.0"
importance: "high"
relevance: "medium"
...
- Nortel sold Clarify to Amdocs for $200M in 2001 — a fraction of the $2.1B paid; CRM market shifted toward Siebel and Salesforce `[ps=4]`
- ClearSupport CommCenter for telecom: simultaneous customer account + network infrastructure access; proactive customer notification; customers MCI, Sprint, TeleNordia `[ps=4]`
...
- Aberdeen expects Clarify will maintain its rapid growth, particularly in IT and telecommunications markets; 'Clarify is a CIS winner and will continue to be so in the future' `[ps=2]`
- Clarify acquired by Nortel Networks in 1999 for $2.1B in stock; validating Aberdeen's 'CIS winner' assessment `[ps=2]`
- Named linchpin accounts: Microsoft, Cisco, HP (IT), MCI, Sprint (telecom), Bay Networks (networking); these customers' partners naturally adopt Clarify `[ps=2]`
- Aberdeen research indicates Clarify has achieved 99% uptime with its customer base `[ps=0]`
