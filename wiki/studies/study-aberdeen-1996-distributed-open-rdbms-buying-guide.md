...
- Relational OLAP identified as critical next-generation DORS capability `[ps=4]`
...
- Viable independent enterprise RDBMS competitor with strong distributed capabilities `[ps=0]`
