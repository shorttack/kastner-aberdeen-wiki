...
- **5-year verdict:** medium — 5y Rule A: mean=3.05 over 20 usable obs (0 prefiltered, 0 pending) -> medium [high>=3.5, medium>=2.0].
...
- Aberdeen: most IS decision makers interviewed do not know EPS exists; HP needs more aggressive sales/marketing campaign urgently `[ps=3]`
...
- 16 ports; 266 Mbit/s per port; 532 Mbit/s full duplex; hub architecture; nodes up to 2 km from switch; target: 32 ports at 1 Gbit/s by 3Q97 `[ps=0]`
- H2 1998: support for 768 processors (64 SMP nodes x 12 processors); interconnect target 10 km by 3Q97 `[ps=0]`
- Highest TPC-C performance ratings on record as of July 1996 `[ps=0]`
