...
- 2x processing power, 5x bandwidth, 20% latency reduction vs prior SPARC architecture `[ps=0]`
- Other Unix SMP implementations require 15-30% CPU overhead when adding processors; Solaris 2.5 finely tuned for near-linear SMP scaling `[ps=0]`
- Ability to easily manage the system `[ps=0]`
