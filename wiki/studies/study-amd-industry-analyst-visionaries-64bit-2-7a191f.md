...
slug: "study-amd-industry-analyst-visionaries-64bit-2-7a191f"
page_type: "study"
tags: ["type/study", "collection/vendor-publication"]
tier: 1
...
_Published 2003, author **AMD (publisher)**, type **vendor-publication**._


## Top observations

- Drivers: declining memory prices, more OS features (security, virtualization), and web-services-driven application growth requiring larger memory footprints `[ps=5]`
- The 64-bit market is dominated by high-end proprietary systems. This will change dramatically over the remainder of the decade. Industry-standard 64-bit architectures will move down to the low-end and up into the mid-range and high-end. `[ps=5]`
- Transition for pervasive 64-bit computing is going to take some time. The server side is well familiar with this technology; the trick is on a desktop, where this is going to take longer. `[ps=5]`
