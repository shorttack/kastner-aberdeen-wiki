...
source_file: "Stratus-XA2000-CW-1987-02-11.pdf"
license: "CC-BY-4.0"
importance: "high"
relevance: "high"
...
- **5-year verdict:** medium — 5y Rule A: mean=2.90 over 10 usable obs (0 prefiltered, 0 pending) -> medium [high>=3.5, medium>=2.0].
...
_Published 1987, author **James Connolly (Computerworld staff)**, type **trade-press-product-launch**._
...
- Selling into a market that has an insatiable appetite for tps; 45% annual growth over next 5 years `[ps=3]`
