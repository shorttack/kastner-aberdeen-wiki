...
- **3-year verdict:** medium — 3y Rule A: mean=3.00 over 11 usable obs (0 prefiltered, 0 pending) -> medium [high>=3.5, medium>=2.0].
...
_Published 1988, author **Peter S. Kastner — DEC Corporate Systems Group, Competitive Marketing Programs**, type **internal-competitive-marketing-paper**._
