...
- EC ISVs must adopt platform strategy; align with web server and transaction management middleware `[ps=4]`
- Payback often less than 12 months with conservative assumptions; investments ranging from $250K to $5M `[ps=3]`
- Internet commerce and object development architectures are a natural match `[ps=3]`
