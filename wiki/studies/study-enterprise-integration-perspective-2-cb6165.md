...
slug: "study-enterprise-integration-perspective-2-cb6165"
page_type: "study"
...
- **3-year verdict:** high — 3y Rule A: mean=3.67 over 18 usable obs (0 prefiltered, 0 pending) -> high [high>=3.5, medium>=2.0].
...
- The edge is gaining lots of intelligence — exemplified by growth in retail store and shop floor computing power `[ps=5]`
- IT investments must be synergistic — over time worth more than sum of individual projects; integration of IT with business processes is area ripe for improving efficiency `[ps=5]`
- Operational tools to remotely monitor, virtually reconfigure, and deploy servers are needed to keep labor costs under control `[ps=5]`
- Best-in-class IT organizations free up 15% of IT budget with lower software maintenance costs vs average `[ps=4]`
- Programmer productivity stuck at 1970s level at many shops — legacy application spaghetti-code soaks up enormous talent for trivial gains `[ps=4]`
- Technologies contributing to KW productivity: collaboration, messaging, smart phones, laptops, podcasting, conferencing, enterprise portals, project management and compliance, ERP, SFA, CRM `[ps=4]`
- Best-in-class organizations show positive ROI for laptops merely from a few minutes of email time gained while waiting for meetings to start `[ps=4]`
