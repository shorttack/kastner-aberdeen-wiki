...
- Manhattan Associates positioned as pioneer in client/server WMS with strong first-mover advantage `[ps=5]`
- Catalyst International was acquired by RedPrairie (now Blue Yonder) — failed to maintain independent position `[ps=5]`
