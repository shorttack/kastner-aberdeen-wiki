...
- Insight 64 believes AMD may have a technology advantage over the next six quarters if it continues smooth execution; Intel and AMD remain in a 'bitter dogfight.' `[ps=5]`
...
- IBM delivered first dual-core POWER4-based systems three years prior (2001); second-generation dual-core shipped spring 2004. `[ps=3]`
