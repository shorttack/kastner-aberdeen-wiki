---
title: "IBM + Webify = Industry SOA Application Jumpstart"
slug: "study-ma-ibm-webify-5e0d4b"
page_type: "study"
tags: ["type/study", "collection/employer-record"]
tier: 1
source_csv: "_master_studies.csv"
study_id: "ma-ibm-webify-5e0d4b"
author: "Peter S. Kastner"
date: "2006-08-03"
pub_year: 2006
type: "employer-record"
subject_domain: "SOA; vertical market applications; enterprise software M&A; application development"
methodology: "Aberdeen Market Alert — analyst commentary on IBM acquisition of Webify Solutions"
...
_Published 2006, author **Peter S. Kastner**, type **employer-record**._


## Top observations

- SOA services will contain a composite of packaged and homegrown applications for the foreseeable future — not a total rewrite `[ps=5]`
- One-third of organizations planning four or more SOA projects in 2006 `[ps=4]`
- General-purpose SOA toolkits (Eclipse IDE) lack vertical-market process orientation — forcing developers to invest time defining basic business-process service building blocks before adding value `[ps=4]`
- IBM can take Webify technology and amplify it around the globe in products and services as only an $80 billion technology giant can `[ps=4]`
- 90% of Global 5000 businesses will exit 2006 with SOA planning, design, or programming activities underway `[ps=3]`
- SOA Lite projects may not sustain common IT failures or follow company or mandated policies due to absence of ESB, repository, management, governance, and lifecycle tools `[ps=3]`
- IBM WebSphere suite of SOA infrastructure software meets the definition of Enterprise SOA `[ps=3]`
- IBM Software Group acquires Webify Solutions to add vertical-market SOA application building blocks to WebSphere and Rational portfolios `[ps=3]`
