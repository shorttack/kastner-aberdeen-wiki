...
slug: "study-midline-storage-white-paper-jun2003"
page_type: "study"
...
_Published 2003, author **Peter Kastner; David Hill / Aberdeen Group**, type **white-paper**._


## Top observations

- Ageing (value and use of content change as content ages); Freezing (content changes from dynamic to fixed); Accumulation (data grows; access per piece drops); Redundancy (more copies for faster access and data protection) `[ps=5]`
- High-capacity online ATA disks in the middle tier between high-use FC/SCSI disk arrays and magnetic tape off-line storage; aimed at data that needs to be online with moderate access and rate-of-change requirements `[ps=5]`
- At least 20% of enterprise data fits the definition of inactive/seldom-used online storage appropriate for high-capacity/low-cost ATA `[ps=5]`
- ATA disks are about half the cost per gigabyte versus FC/SCSI `[ps=4]`
- Midline solutions can be as much as half the price of high-performance disk-based systems `[ps=4]`
