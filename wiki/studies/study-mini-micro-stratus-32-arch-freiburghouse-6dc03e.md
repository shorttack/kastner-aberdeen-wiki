...
- Failed board can be replaced in running system by nontechnical person without special tools `[ps=3]`
- Robert Freiburghouse, Stratus Computer (architect; bylined author) `[ps=0]`
- Up to 32 processing modules per system `[ps=0]`
- 32 MB/sec potential, 16 MB/sec actual; 125-nsec cycle; 32-bit data path `[ps=0]`
