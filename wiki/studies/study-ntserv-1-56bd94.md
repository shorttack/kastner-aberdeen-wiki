...
- Windows NT servers part of strategic plans for more than 90% of Fortune 1000 IS executives `[ps=5]`
- Windows 2000 shipped February 17 2000 — verify and update. `[ps=5]`
- NT application revenues ~$2B in 1997; will grow to ~$13 billion by 2001 `[ps=4]`
- NT deployments increasingly require professional services; IS without staff NT experience common `[ps=4]`
