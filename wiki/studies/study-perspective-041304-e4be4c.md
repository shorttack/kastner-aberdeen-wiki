...
- Itanium will increasingly host former mainframe workloads `[ps=1]`
- Itanium ecosystem matured; nearly all major EBAs support Itanium with customers in production `[ps=1]`
- ~40% of mainframe users `[ps=0]`
