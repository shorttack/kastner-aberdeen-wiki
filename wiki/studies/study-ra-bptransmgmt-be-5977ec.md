...
- $18 billion tiremaker with dozens of North American shipping locations servicing nearly 20,000 ship-to locations `[ps=0]`
- To supplement the process, com- **LifeWay Christian Resources** plex routing rules were stored in spreadsheets and updated sporadically, while e- Owned and operated by the Southern Bap-wned and operated by the Southern Bapmails chased orders containing specific tist Convention, LifeWay is a $428 million t Convention, LifeWay is a $428 million routing rules. nonprofit publisher of religious materia `[ps=0]`
- Owned and operated by the Southern Bap-wned and operated by the Southern Baptist Convention, LifeWay is a $428 million t Convention, LifeWay is a $428 million nonprofit publisher of religious material sold online as well as through its chain of 124 LifeWay stores and mass retailers `[ps=0]`
- The company had already invested in technology for its order management and warehouse processes, including deploying laptops to its field sales force, using EDI to connect to customers, and building a highly automated warehouse that could pick over 90% of orders the same day they are dropped. `[ps=0]`
- Consumer goods manufacturer with five distribution centers; 1,300 shipments a day; and $25 million annual freight spend `[ps=0]`
