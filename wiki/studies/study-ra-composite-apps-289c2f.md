...
slug: "study-ra-composite-apps-289c2f"
page_type: "study"
...
- **3-year verdict:** medium — 3y Rule A: mean=3.10 over 90 usable obs (0 prefiltered, 0 pending) -> medium [high>=3.5, medium>=2.0].
- **5-year verdict:** medium — 5y Rule A: mean=3.37 over 90 usable obs (0 prefiltered, 0 pending) -> medium [high>=3.5, medium>=2.0].
...
_Published 2006, author **Rick Saia and Peter S. Kastner, Aberdeen Group**, type **employer-record**._
