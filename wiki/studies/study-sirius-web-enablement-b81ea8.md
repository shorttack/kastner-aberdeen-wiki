...
slug: "study-sirius-web-enablement-b81ea8"
page_type: "study"
tags: ["type/study", "collection/market-study"]
tier: 2
source_csv: "_master_studies.csv"
study_id: "sirius-web-enablement-b81ea8"
...
source_file: "1997 Sirius – The Case For Web Enablement By Mainframe Upgrade pr.pdf"
license: "CC-BY-4.0"
importance: "medium"
relevance: "medium"
...
_Published 1997, author **Wayne Kernochan (Aberdeen Group)**, type **market-study**._


## Top observations

- Tools arriving and improving; Janus Web Server cited as key example
- Rewrite — write application from scratch on Web server
- Migrate and upgrade — move mainframe app to web server then web-enable it
- Upgrade in place — web-enable mainframe application while keeping it on mainframe
- Paradoxically positive — made it easier to keep and web-enable mainframe apps rather than replace them
- Migration or rewriting results in applications that are less scalable and robust than original mainframe apps
- Product expected to improve and gain adoption for mainframe web-enablement
- Acquired by Rocket Software in November 2012 for undisclosed sum; products continued under Rocket M204 brand
- IBM mainframe (z/OS) remains in active production at major banks and government agencies nearly 30 years after study
...
- In-place web-enablement offers cost-effective Internet connectivity with minimal impact on production environment
- Computer Corporation of America acquired by Rocket Software in March 2010; Model 204 rebranded as Rocket M204
