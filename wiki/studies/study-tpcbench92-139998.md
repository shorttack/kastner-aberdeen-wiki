...
- King for a day: weekly jockeying for best position; beware of out-of-date information `[ps=5]`
- Buyers will benefit from supplier competition; competition breeds better price and performance `[ps=5]`
- Founded 1988 with Aberdeen principal help; independent supplier-sponsored benchmarking standards body `[ps=4]`
- TPC-A (TP), TPC-B (database), TPC-C (coming - WIC) `[ps=4]`
- Primary vehicle for commercial system price and performance competition `[ps=4]`
- IBM mainframes missing in action; IBM said 'not appropriate' but Unisys ran one; TPC forbids estimation; IBM has enough problems selling S/390s `[ps=4]`
- Suppliers are aggressively optimizing price and performance `[ps=4]`
