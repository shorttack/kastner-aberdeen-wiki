...
source_file: "Intel-fail-quote-psk-1994-USA-Today-2.pdf"
license: "CC-BY-4.0"
importance: "high"
relevance: "high"
...
- **3-year verdict:** medium — 3y Rule A: mean=2.82 over 11 usable obs (0 prefiltered, 0 pending) -> medium [high>=3.5, medium>=2.0].
- **5-year verdict:** medium — 5y Rule A: mean=2.73 over 11 usable obs (0 prefiltered, 0 pending) -> medium [high>=3.5, medium>=2.0].
...
_Published 1994, author **Kevin Maney (USA Today)**, type **trade-press-feature**._
