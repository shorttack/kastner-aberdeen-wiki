...
tags: [type/technology, category/directory-protocol, vendor/ietf]
source_csv: known_technologies.csv
---

# LDAP (Lightweight Directory Access Protocol)

LDAP (Lightweight Directory Access Protocol) is a directory-protocol from IETF (era 1993-present). Current lifecycle: mainstream.
...
```sql
SELECT * FROM observations WHERE tech_id = 'TECH-LDAP';
```
