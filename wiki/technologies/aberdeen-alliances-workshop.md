...
study_count: 1
obs_count: 1
aliases: ["Aberdeen Alliances Workshop"]
...
Aberdeen Alliances Workshop is a application from Aberdeen Group (era 2001). Current lifecycle: discontinued.
...
```sql
SELECT * FROM observations WHERE tech_id = 'aberdeen-alliances-workshop';
```
