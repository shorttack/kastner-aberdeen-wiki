...
study_count: 1
obs_count: 2
aliases: ["Aberdeen Messaging Strategy Workshop"]
...
Aberdeen Messaging Strategy Workshop is a application from Aberdeen Group (era 2001). Current lifecycle: discontinued.
...
```sql
SELECT * FROM observations WHERE tech_id = 'aberdeen-messaging-strategy-workshop';
```
