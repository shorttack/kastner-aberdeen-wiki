---
title: "Microsoft BackOffice"
slug: "backoffice"
page_type: "technology"
tags: ["type/technology", "category/application-suite", "era/1994-2000"]
tier: 2
...
> BackOffice suite (Exchange, SQL Server, SNA Server, Systems Management Server) central to Microsoft's enterprise pitch. Discontinued as bundle ca. 2002.


## Top observations

- NT and BackOffice require capable partner help for enterprise-class: high transaction rates, high availability, fault tolerance, mainframe connectivity, systems management `[ps=4]` — [[study-1997-microsoft-nt-scalability-day--the-e-6460e2]]
- Three-fold: 1) lower cost hardware/software platform, 2) more open, 3) direct path to client-server with PC interface `[ps=4]` — [[study-aberdeen-1996-ibm-as400-vs-microsoft-nt-server]]
- Fewer than 10,000 BackOffice installations running business-critical OLTP applications `[ps=4]` — [[study-aberdeen-1996-ibm-as400-vs-microsoft-nt-server]]
- AS/400 base prefers supplier-integrated value; BackOffice requires component assembly — fundamental culture mismatch `[ps=4]` — [[study-aberdeen-1996-ibm-as400-vs-microsoft-nt-server]]
