---
title: "Client-server computing architecture"
slug: "client-server-architecture"
page_type: "technology"
tags: ["type/technology", "category/system-architecture", "era/1980s-1990s"]
tier: 1
source_csv: "_master_technologies.csv"
tech_id: "client-server-architecture"
...
- Mature but under threat from web-native architectures `[ps=4]` — [[study-1999-managing-customers-with-next-generation-software-a-a5adc4]]
...
- Shortened from 2-3 years to less than 1 year due to 4GL tools `[ps=3]` — [[study-aberdeen-1996-sqa-suite-50-automated-testing]]
