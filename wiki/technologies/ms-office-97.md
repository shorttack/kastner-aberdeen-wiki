...
Microsoft Office 97 is a application from Microsoft (era 1997-2003). Current lifecycle: retired.
...
```sql
SELECT * FROM observations WHERE tech_id = 'ms-office-97';
```
