---
title: "Oracle Database (RDBMS)"
slug: "oracle-rdbms"
page_type: "technology"
tags: ["type/technology", "category/relational-DBMS", "era/1979-present"]
tier: 1
source_csv: "_master_technologies.csv"
tech_id: "oracle-rdbms"
...
> SAP R3 back-end database; Oracle uses HP 9000 as Unix reference port; Oracle SQL*NET for distributed connectivity
...
- Oracle wants to beat IBM mainframes and protect Ellison's nCube investment, but its technology is behind the market. `[ps=3]` — [[study-1994-surfing-the-parallel-architectures--c52d66]]
- Oracle7 is the robust, proven, scalable data repository underneath InterOffice. `[ps=3]` — [[study-1996-oracle-interoffice-workgroup-collab-4e68a3]]
- Aggressive TPC benchmarking + channel pricing + PL/SQL lock-in as three-pillar retention strategy `[ps=3]` — [[study-2026-kastner-oracle-longitudinal]]
- Oracle held approximately 42% of RDBMS market revenue 1997 `[ps=3]` — [[study-2026-kastner-oracle-longitudinal]]
