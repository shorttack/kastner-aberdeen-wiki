...
study_count: 0
obs_count: 0
aliases: ["Operations Support Systems (OSS)"]
...
Operations Support Systems (OSS) is a application from various (era 1970-present). Current lifecycle: active.
...
```sql
SELECT * FROM observations WHERE tech_id = 'oss';
```
