---
title: "Remote Control Architecture"
slug: "remote-control-arch"
page_type: "technology"
tags: ["type/technology", "category/protocol", "era/1985-2005"]
tier: 2
source_csv: "_master_technologies.csv"
tech_id: "remote-control-arch"
category: "protocol"
...
> Dumb terminal model; computing at corporate LAN; only GUI/keystrokes traverse link; evolved into RDP (Microsoft) and ICA (Citrix)


## Top observations

- Access to large databases and legacy applications from remote locations is required `[ps=5]` — [[study-when-does-remote-control-benefit-9bd6e4]]
- Enables full advantage of corporate desktop horsepower from remote location; computing done at corporate site `[ps=4]` — [[study-when-does-remote-control-benefit-9bd6e4]]
