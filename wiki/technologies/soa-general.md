...
tags: ["type/technology", "category/architectural-framework", "era/2000s"]
tier: 2
...
> Core subject of Kastner's research; drives integration, complexity management, faster deployment. Promise real but benefits not yet widely distributed.
...
- SOA enables IT to be more productive under ongoing budget pressures `[ps=3]` — [[study-soa-aon-webinar-31973c]]
- SOA Benefits Begin with IT for Mid-Size Enterprises; SOA is Made to Order for Mid-Size Manufacturers; Complexity Drives Discrete Manufacturers to SOA `[ps=3]` — [[study-soa-aon-webinar-31973c]]
- Faster deployment, easier integration, quicker customization `[ps=3]` — [[study-soa-overview-docx-12612f]]
- Initial IT benefits must precede business benefits in SOA adoption `[ps=3]` — [[study-soa-overview-docx-12612f]]
- Industry in transitional phase; many organizations recognizing limitations of traditional integration `[ps=3]` — [[study-soa-overview-docx-12612f]]
- BPM research encouraged service-oriented approaches facilitating microservices development `[ps=3]` — [[study-soa-with-bpm-docx-1211c7]]
- 92% at or below 25% SOA adoption rate in 2005 `[ps=0]` — [[study-soa-aon-webinar-31973c]]
- 29.6% of IT budget on innovation (vs. 18.5% average); +11pp advantage `[ps=0]` — [[study-soa-aon-webinar-31973c]]
