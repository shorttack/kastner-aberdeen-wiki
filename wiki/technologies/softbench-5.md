---
title: "HP C++ SoftBench 5.0"
slug: "softbench-5"
page_type: "technology"
tags: ["type/technology", "category/IDE", "era/unknown"]
tier: 2
...
> Discontinued with HP-UX developer tools; no longer commercially available


## Top observations

- Using the Encapsulator, SoftBench embeds third-party tools so they share the same user interface and seamlessly communicate with each other enabling best-of-breed tool selection `[ps=4]` — [[study-aberdeen-1995-hp-softbench]]
- HP's experience shows customers first inventory existing applications to determine what should be encapsulated and linked to new OO applications using C++ SoftBench and UIM/X `[ps=4]` — [[study-aberdeen-1995-hp-softbench]]
- SoftBench graphically depicts application structure and object inheritance, shortening the time needed for new developers to learn object technology `[ps=3]` — [[study-aberdeen-1995-hp-softbench]]
- New SoftBench 5.0 Graphical Class Editor allows developers to visually edit objects with changes automatically reflected in underlying C++ code by making static analysis database read-write `[ps=3]` — [[study-aberdeen-1995-hp-softbench]]
