...
- TP1 and ET1 are NOT the same benchmark or even a variation; vendor comparisons based on TP1-vs-ET1 results are invalid `[ps=4]` — [[study-stratus-et1-functional-spec-and-benchmar-0c3172]]
...
- 150ms CPU loop + 5 indexed reads + 2 rewrites + 1 sequential log write; PL1 requester, COBOL server; Stratus TPF `[ps=0]` — [[study-stratus-et1-functional-spec-and-benchmar-0c3172]]
