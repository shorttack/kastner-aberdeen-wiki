---
title: "Multidimensional OLAP (MOLAP)"
slug: tech-02
...
study_count: 2
obs_count: 14
aliases: ["Multidimensional OLAP (MOLAP)"]
tags: [type/technology, category/analytical-framework, vendor/multiple]
source_csv: known_technologies.csv
---

# Multidimensional OLAP (MOLAP)

Multidimensional OLAP (MOLAP) is a analytical-framework from multiple (era 1990-present). Current lifecycle: legacy-niche.

**Appears in 2 studies, 14 observations.**
...
```sql
SELECT * FROM observations WHERE tech_id = 'tech-02';
```
