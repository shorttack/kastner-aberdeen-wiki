...
slug: "virtual-data-warehouse"
page_type: "technology"
tags: ["type/technology", "category/architecture-pattern", "era/unknown"]
tier: 2
source_csv: "_master_technologies.csv"
tech_id: "virtual-data-warehouse"
...
> description=A decision-support environment using metadata to provide unified access to distributed data sources without physical data consolidation, introduced October 2, 1995.; lifecycle_note=The virtual data warehouse concept evolved into data virtualization and, more recently, data fabric architectures. The specific Intersolv product was discontinued after Merant/Micro Focus restructuring.; successor_technology=data-virtualization / data-fabric


## Top observations

- Data warehousing and business intelligence became mainstream by late 1990s. Gartner data warehouse market grew substantially; Oracle, Teradata, IBM competed heavily. Most large enterprises had BI/DSS by 2000 validating Aberdeen prediction. `[ps=5]` — [[study-aberdeen-1995-intersolv-virtual-data-warehouse]]
- Virtual/federated data access gained traction in 2000s as data virtualization (Composite Software, Denodo); physical data warehouses also proliferated. Both approaches coexist. Intersolv was acquired by Micro Focus for $534M in 1998; DataDirect ODBC technology survived as Progress DataDirect. Virtual warehouse concept evolved into data virtualization and later data fabric. `[ps=5]` — [[study-aberdeen-1995-intersolv-virtual-data-warehouse]]
- Aberdeen believes that by the end of the decade most enterprises will be using some form of complex decision support to help develop a better understanding of customers. `[ps=4]` — [[study-aberdeen-1995-intersolv-virtual-data-warehouse]]
- SmartSets are dynamic virtual databases that generate the SQL necessary for a specific request; they can contain tables and joins from multiple different sources and are presented in business-user language. `[ps=4]` — [[study-aberdeen-1995-intersolv-virtual-data-warehouse]]
- Other users believe the enterprise can use the Virtual Data Warehouse while building a physical warehouse, with the Virtual Data Warehouse design subsequently enfoldable within a physical warehouse. `[ps=4]` — [[study-aberdeen-1995-intersolv-virtual-data-warehouse]]
