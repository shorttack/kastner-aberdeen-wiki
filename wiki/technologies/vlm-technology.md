...
> 64-bit architecture enabling 5+ GB main memory; Aberdeen defines as >5GB system memory with DB support


## Top observations

- 64-bit VLM (>4GB RAM) enables higher performance for data warehousing and mixed OLTP/DSS Internet applications `[ps=5]` — [[study-aberdeen-1996-computer-telephony-integration]]
