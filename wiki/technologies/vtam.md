...
- VTAM (IBM's mainframe communications manager) required more than one full 3090 CPU-second just to log in a single 3270 terminal session. `[ps=1]` — [[study-volume-1-ch06-dec-mainframes-last-stand-1987-1988]]
