...
- 100 TPS benchmark required 10,000 virtual terminals × 1 CPU-second = 10,000 CPU-seconds of session overhead; over an hour of clock time on a 4-processor 3090-400 before a single transaction. — [[study-volume-1-ch06-dec-mainframes-last-stand-1987-1988]]
