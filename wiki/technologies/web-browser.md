---
title: "Web Browser (Netscape Navigator / MSIE)"
slug: "web-browser"
page_type: "technology"
tags: ["type/technology", "category/client software", "era/1993-present"]
tier: 2
source_csv: "_master_technologies.csv"
tech_id: "web-browser"
category: "client software"
vendor: "Netscape/Microsoft"
era: "1993-present"
...
> Proposed thin client for decision support; $50/seat vs $1,000/seat DSS software; Aberdeen's economic centerpiece


## Top observations

- Web browser: approximately $50/seat (quantity 1) vs. average $1,000/seat for traditional decision-support software `[ps=5]` — [[study-aberdeen-1996-web-warehouses-dss-for-masses]]
...
- Thin-client Web browser (e.g., Netscape); WAN/LAN using TCP/IP; HTTP server; CGI scripts; firewall for enterprise-network privacy; application RDBMS. `[ps=4]` — [[study-ca-internet-app-dev-sales-training-1996-48db9c]]
- Web application architecture (server-side app + browser presentation) became the dominant enterprise-app architecture by ~2001 and remains so. Kastner prediction verified. `[ps=4]` — [[study-ca-internet-app-dev-sales-training-1996-48db9c]]
